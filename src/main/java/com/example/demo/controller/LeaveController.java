...
public class LeaveController {
    ...
    public String processStatus(String processId) {
        boolean b = testLeaveService.queryProcessIsEnd(processId);
        return "status:" + b;
    }

    @RequestMapping("/process/bytaskid")
    public String processByTaskID(String taskId) {
        ProcessInstance processInstance = testLeaveService.findProcessInstanceByTaskId(taskId);
        return "status:" + processInstance.isEnded();
    }
}
